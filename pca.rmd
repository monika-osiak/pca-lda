...
Zaczynamy od załadowania zbioru i policzenia wariancji.
...
Estymacja parametrów przeprocesowania: 
...
```
I jakieś wykresy jeszcze -- do opisania.
```{r}
...
## Wnioski
1. Podstawową różnicą między metodami jest to, że LDA jest metodą nadzorowaną (występuje wstępny podział na klasy), natomiast PCA jest nienadzorowana (nie posiada wstępnego podziału).
...
3.Dla metody PCA otrzymaliśmy 2-wymiarowy podział na klasy, natomiast dla LDA jednowymiarowy. Dlatego ciężko jest wizualnie porównać obie metody.